...
class PaymentService
{
     ...
     *
     * The operation is transactional and locks the invoice row so
     * concurrent payments cannot both consume the same balance.
     *
     * An idempotency key identifies a single payment operation:
     *
     * - exact retry -> existing payment is returned
     * - same key with different payment data -> rejected
     *
    ...
    /**
     * Ensure an existing payment is a genuine retry of the same operation.
     *
     * @throws MathException
     */
    ...
    /**
     * Normalize and validate a payment method.
     */
    ...
    /**
     * Normalize a strictly positive monetary amount.
     *
     * @throws MathException
     */
    ...
    /**
     * Convert an external monetary amount into exact decimal form.
     *
     * @throws MathException
     */
